...
app.get("/resume", function (req, res)
{
 ...
 {
    res.send("All rights are reserved for Sean Devang Gor. Distribution of any code/website content without my consent is subject to fines and/or other penalties.");
 });
 ...
 app.post("/contact", (req, res) => {
    ...
    res.send("Thank you. Your response has been recorded and sent to Sean. Please hit the left arrow button to go back to the previous page");
});

app.listen(port, function () {
  console.log("NodeJS app listening on http://localhost:" + port + "/main");
});